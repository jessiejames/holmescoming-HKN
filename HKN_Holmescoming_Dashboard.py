#need to change padding on grid on display monitor
import serial
import Tkinter
import tkMessageBox
from Tkinter import *
...
gui = Tkinter.Tk()
gui.configure(cursor = "crosshair", bg = "white")
...
logo_label.grid(column = 3, row = 1, padx = 25, pady = 25)

logo2_label = Label(image = logo2, bg = "white")
logo2_label.grid(column = 1, row = 1)
